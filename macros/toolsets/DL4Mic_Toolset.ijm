...
function train() {
	...
	command = "cd "+baseFolder+"; "+_PYTHON_INTERPRETER+" "+script+" "+parameters+" 2>&1 | tee log.txt";
	logPath = _NETWORKS_DIR + File.separator + _CURRENT_NETWORK + File.separator + "log.txt";
	File.delete(logPath);
