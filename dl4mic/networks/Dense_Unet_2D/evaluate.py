...
def main(argv):
    ...
    # Load the model
    denseUnet = load_model(os.path.join(full_QC_model_path, 'weights_best.hdf5'),
    ...
    for i in range(number_of_dataset):
        ...
        predictions.append(predict_as_tiles(os.path.join(args.testInputPath, source_dir_list[i]), denseUnet))
